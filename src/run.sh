...
#        for gamma in 0
#        do
#           for beta in -1 0 0.9 0.99 0.999
#           do
...
python3 ./src/run.py cv=0 evaluate=1 mode=horizontal type=N preprocess=Add_BlackRects sampler=normal gamma=0 beta=0 lr=0.0005 epoch=79
python3 ./src/run.py cv=0 evaluate=1 mode=horizontal type=N preprocess=Add_BlackRects sampler=under gamma=0.5 beta=-1 lr=0.0005 epoch=65
